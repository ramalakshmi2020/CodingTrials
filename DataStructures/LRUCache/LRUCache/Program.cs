...
namespace LRUCache
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            cache1.Set(2, 6);
            Console.WriteLine("Result of Get(2) after setting [1,1],[2,2][3,3] is {0} ", cache1.Get(2));
            cache1.Set(1, 5);
            cache1.Set(1, 2);
            Console.WriteLine("Result of Get(1) (it got evicted  already) is {0} ", cache1.Get(1));
            Console.WriteLine("Result of Get(3) is {0} ", cache1.Get(2));
            //Console.WriteLine("Result of Get(3) is {0} ", cache.Get(4));
